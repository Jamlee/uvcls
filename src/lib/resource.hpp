#ifndef UVCLS_RESOURCE_INCLUDE_H
#define UVCLS_RESOURCE_INCLUDE_H
...
/**
 * @brief Common class for almost all the resources available in `uvcls`.
 *
...
public:
    ...
    /**
     * @brief Gets user-defined data. `uvcls` won't use this field in any case.
    ...
    /**
     * @brief Sets arbitrary data. `uvcls` won't use this field in any case.
...
#endif // UVCLS_RESOURCE_INCLUDE_H
